...
- Âm thanh (engine v2): đúng → **chuông vui** (chuỗi nốt đi lên), sai → **tiếng
  trầm** ngắn nhẹ (Web Audio, offline). Luôn có nút **🔊/🔇** để tắt nhanh. Bật/tắt
  mặc định qua `settings.sound`; lớp học cạnh nhau ồn thì để `false`. Chuông báo
  **hết giờ** của đồng hồ vẫn kêu kể cả khi tắt âm đáp án (đó là tín hiệu cho GV).
